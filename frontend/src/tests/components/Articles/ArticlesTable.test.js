...
describe("ArticlesTable tests", () => {
  ...
  test("Delete button calls delete callback", async () => {
    ...
    expect(screen.getByTestId(`${testId}-cell-row-0-col-title`)).toHaveTextContent("How to use Spring Data JDBC with Spring Boot");
    expect(screen.getByTestId(`${testId}-cell-row-0-col-url`)).toHaveTextContent("https://www.youtube.com/watch?v=l_T0nQNbFiM");
    expect(screen.getByTestId(`${testId}-cell-row-0-col-explanation`)).toHaveTextContent("This is a great video that explains how to use Spring Data JDBC with Spring Boot");
    expect(screen.getByTestId(`${testId}-cell-row-0-col-email`)).toHaveTextContent("andyouyang@ucsb.edu");
    expect(screen.getByTestId(`${testId}-cell-row-0-col-dateAdded`)).toHaveTextContent("2022-04-21T00:00:00");
