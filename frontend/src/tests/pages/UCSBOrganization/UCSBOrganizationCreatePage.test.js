...
describe("UCSBOrganizationCreatePage tests", () => {
    ...
    test("on submit, makes request to backend, and redirects to /ucsborganization", async () => {
        ...
        fireEvent.change(orgCodeInput, { target: { value: "MD" } })
        fireEvent.change(orgTranslationShortInput, { target: { value: "Mu Delta" } })
        fireEvent.change(orgTranslationInput, { target: { value: "Mu Delta" } })
