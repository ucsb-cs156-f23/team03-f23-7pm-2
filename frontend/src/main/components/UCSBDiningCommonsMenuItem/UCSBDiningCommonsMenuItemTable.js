...
export default function UCSBDiningCommonsMenuItemTable({
    ...
    const deleteMutation = useBackendMutation(cellToAxiosParamsDelete, {onSuccess: onDeleteSuccess}, ["/api/ucsbdiningcommonsmenuitem/all"]);
    // Stryker restore all
    ...
    const columns = [{
        ...
        Header: 'Dining Commons Code', accessor: 'diningCommonsCode',
    }, {
